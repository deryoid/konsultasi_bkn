...
$id = $_GET['id'];
$data = $koneksi->query("SELECT * FROM kategori WHERE id_kategori = '$id'");
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    if (isset($_POST['submit'])) {
        $nama_kategori = str_replace("'", "\\'", $_POST['nama_kategori']);
        $deskripsi  = $_POST['deskripsi'];

        $submit = $koneksi->query("UPDATE kategori SET nama_kategori='$nama_kategori', deskripsi='$deskripsi' WHERE id_kategori='$id'");
