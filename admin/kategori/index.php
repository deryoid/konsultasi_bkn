                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $row['deskripsi'] ?></td>
                                                    <td align="center">
                                                        <a href="edit.php?id=<?= $row['id_kategori'] ?>" class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                                        <a href="hapus.php?id=<?= $row['id_kategori'] ?>" class="btn btn-danger btn-sm alert-hapus" title="Hapus"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                            </tbody>
