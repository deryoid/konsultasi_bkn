                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body" style="background-color: white;">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="username" name="nama_user" value="<?= $row['nama_user'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control select2" data-placeholder="Pilih Role" id="role" name="role" required>
                                                    ...
                                                    <option value="Konselor" <?php if ($row['role'] == "Konselor") { echo "selected"; } ?>>Konselor</option>
