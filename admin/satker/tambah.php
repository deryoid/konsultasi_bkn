...
<body class="hold-transition sidebar-mini layout-fixed">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" style="background-color: white;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="id_satker">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea type="text" class="form-control" name="lokasi"></textarea>
                                            </div>
                                        </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $submit = $koneksi->query("INSERT INTO satker VALUES ('$id_satker','$satker', '$lokasi')");
