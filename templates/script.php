  ...
  <script>
    $(function() {
      ...
      $('.alert-logout').on('click', function() {
          ...
          Swal.fire({
            title: 'Anda Akan Keluar Dari Aplikasi, Lanjutkan ?',
            icon: "warning",
            confirmButtonText: 'OK',
            confirmButtonColor: '#DD6B55',
            showCancelButton: true,
            cancelButtonColor: '#337ab7', // Ubah warna button cancel menjadi primary
            cancelButtonText: 'Batal', // Ubah teks button cancel
          }).then((result) => {
      ...
      $('.alert-hapus').on('click', function() {
        var getLink = $(this).attr('href');
          Swal.fire({
            title: 'Data Akan Dihapus, Lanjutkan ?',
            icon: "warning",
            confirmButtonText: 'OK',
            confirmButtonColor: '#DD6B55',
            showCancelButton: true,
      ...
      $('.alert-batalkan').on('click', function() {
        var getLink = $(this).attr('href');
        Swal.fire({
            title: 'Apakah Anda Ingin Membatalkan Perjanjian, Lanjutkan ?',
            icon: "warning",
            confirmButtonText: 'OK',
            confirmButtonColor: '#DD6B55',
            showCancelButton: true,
